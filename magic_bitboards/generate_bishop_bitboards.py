    ...
    for shift in range(50, 64):
        ...
        if found_magic_number:
            ...
            if have_all_magic_numbers:
                ...
                out = list_to_c_uint64_array("bishop_magic_numbers", best_magic_numbers) + "\n"
                out += list_to_c_uint64_array("bishop_attack_masks", table) + "\n"
                out += list_to_c_uint8_array("bishop_magic_shifts", best_shifts) + "\n"
                out += table_to_c_uint64_array("bishop_attack_tables", attack_tables)
